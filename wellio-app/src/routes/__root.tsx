...
function Root(){return <html lang="en"><head><HeadContent/></head><body><I18nProvider><WellioProvider><AppShell><Outlet/></AppShell></WellioProvider></I18nProvider><Scripts/></body></html>}
